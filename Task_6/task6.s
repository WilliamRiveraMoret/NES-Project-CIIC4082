...
Loop:
  ...
  LDA display_gameover_letters, X
...
Loop:
  ...
  LDA display_gamecleared_letters, X
...
; checker w/ 2 offsets and 3 vars: 1st #, 2nd #,

; if 2nd # has a 0, then subtract the 1st #
...
attributes:
  ...
  .byte %01010101, %01010101, %01010101, %01010101, %01010101, %01010101, %01010101, %01010101 ; 1
...
map:
  ...
  .byte %10101010, %10101010, %10101010, %10101010 ; 1 
  ...
  .byte %01111100, %01000000, %00111111, %00110000 ; 13
  ...
  .byte %10000100, %01000100, %11010001, %00111100 ; 4
  ...
  .byte %10001100, %01010000, %01011111, %00110000 ; 13
  ...
  .byte %00000000, %01001100, %00111100, %01010000 ; 13
...
previous_timer_left: .res 1

previous_timer_right: .res 1